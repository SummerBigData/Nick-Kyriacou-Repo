...
patches = np.genfromtxt('output_folder/randomly_sampled_10k_15x15_pixel_images.out')  # (10000, 225)
...
theta_final = np.genfromtxt('output_folder/optimal_thetas_l_10_B_0.5_Rho_0.05.out')
