...
"""
    ...
    2) Creates 30 overlapping intervals for the vars p1_IsoBDT, p2_IsoBDT and p0_track_Chi2D resulting in 27k hypercubes.
    
    3) Cluster the points inside these intervals (5 points or more form a cluster, we use DBSCAN with a high eps). 
    ...
    7) Color the nodes by the ratio of signal vs. no signal.
    
    8) Show the y-labels (signal or no signal) for every cluster member inside a tooltip.
