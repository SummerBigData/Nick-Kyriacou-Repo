...
agr_test = slLoadCsv("correlation_tests/check_agreement.csv", False);
check_correlation = slLoadCsv("correlation_tests/check_correlation.csv", False);
train = slLoadCsv("data/training.csv", False);
test = slLoadCsv("data/test.csv", False);
